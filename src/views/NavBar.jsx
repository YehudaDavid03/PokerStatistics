...
const NavBar = ({ gamesRender, loading, userInfoReceived, logout }) => {
  ...
  return (
    <div className="nav-bar-main">
      {userInfoReceived.jwt ? <h5 onClick={() => {logout()}}>Logout <span className="material-icons-outlined">arrow_forward_ios</span></h5> : <h1>Poker Statistic DashBoard <span className="material-icons-outlined">arrow_forward_ios</span></h1>}
